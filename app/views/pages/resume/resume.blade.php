    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="assets/resume/assets/images/profilepic.jpg" alt="" />
                <h1 class="name">Amit Kumar Gupta</h1>
                <h3 class="tagline">Web Application Developer</h3>
            </div><!--//profile-container-->
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i><a href="mailto: amitgpt773@gmail.com">amitgpt773@gmail.com</a></li>
                    <li class="phone"><i class="fa fa-phone"></i><a href="tel:0123 456 789">+91 9041 539 368</a></li>
                    ...
                    <li class="linkedin"><i class="fa fa-linkedin"></i><a href="http://linkedin.com/in/amit-gupta-5474ab50" target="_blank">linkedin.com/in/amit-gupta-5474ab50</a></li>
                    <li class="github"><i class="fa fa-github"></i><a href="https://github.com/amitgpt" target="_blank">github.com/amitgpt</a></li>
                    <li class="twitter"><i class="fa fa-twitter"></i><a href="https://twitter.com/amitgpt773" target="_blank">@amitgpt773</a></li>
                </ul>
            </div><!--//contact-container-->
            <div class="education-container container-block">
                <h2 class="container-block-title">Education</h2>
                <div class="item">
                    <h4 class="degree">Master of Computer Application (MCA)</h4>
                    <h5 class="meta"> KUK ( Haryana )</h5>
                    <div class="time">2010 - 2013</div>
                </div><!--//item-->
                <div class="item">
                    <h4 class="degree">Bachelor of Computer Application (BCA)</h4>
                    <h5 class="meta">JPU (CHAPRA, BIHAR)</h5>
        ...
        <div class="main-wrapper">
            ...
            <section class="skills-section section">
                ...
                <div class="skillset">        
                    ...
                    <div class="item">
                        <h3 class="level-title">PHP Framework (Laravel, Cakephp, Yii) </h3>
                        <div class="level-bar">
                    ...
                    <div class="item">
                        <h3 class="level-title">Javascript, jQuery  &amp; Ajax</h3>
                        <div class="level-bar">
                            <div class="level-bar-inner" data-level="98%">
                            </div>                                      
                        </div><!--//level-bar-->                                 
                    ...
                    <div class="item">
                        <h3 class="level-title">Rest API</h3>
                        <div class="level-bar">
                    ...
                    <div class="item">
                        <h3 class="level-title">Objective - C</h3>
                        <div class="level-bar">
